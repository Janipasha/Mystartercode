...
// Set a click listener on that View
        numbers.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent numbersIntent = new Intent(MainActivity.this, NumbersAcitivity.class);
                startActivity(numbersIntent);
            }
        });
        TextView familyId = (TextView) findViewById(R.id.family);
...
// Set a click listener on that View
        ...
        TextView colorId = (TextView) findViewById(R.id.colors);
...
// Set a click listener on that View
        ...
        TextView phrasesId = (TextView) findViewById(R.id.phrases);
